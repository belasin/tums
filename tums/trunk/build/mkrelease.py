...
if len(sys.argv) > 1:
    ...
    os.system("rm -rf /storage/vulani-build-lenny/Vulani/tums/branches/rel/%s" % relnum)
    print "Creating and tagging branch"
    os.system("cp -a /storage/vulani-build-lenny/Vulani/tums/trunk/release /storage/vulani-build-lenny/Vulani/tums/branches/rel/%s" % relnum)

    loc = os.getcwd()

    newwd = "/storage/vulani-build-lenny/Vulani/tums/branches/rel/%s" % relnum
    ...
    if os.getcwd() == newwd:
        ...
        os.system('echo > /storage/vulani-build-lenny/freezeLog')
        ...
        for name, filen in fi:
            ...
            os.system("/storage/vulani-build-lenny/Vulani/tums/trunk/build/Python-2.5.1/Tools/freeze/freeze.py -x %s %s >> /storage/vulani-build-lenny/freezeLog 2>&1" % (myList, filen))
            print ".", 
            os.system("make >> /storage/vulani-build-lenny/freezeLog 2>&1")
            print ".", 
            os.system("rm *.c *.o")
