...
def createForm(self, form):
    ...
    form.addField('type', formal.String(required=True),
            formal.widgetFactory(formal.SelectChoice, options = [('usb', 'USB'), ('smb', 'Windows Share')]), label = "Backup Type")
   ...
   #USB fields
    ...
    form.addField('smbUser', formal.String(required=False), label = "Username")
    form.addField('smbPass', formal.String(required=False), label = "Password")
