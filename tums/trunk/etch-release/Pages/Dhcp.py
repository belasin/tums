...
def createForm(form):
    form.addField('domain', formal.String(strip=True), label = "Domain", description="Domain name")
...
class Page(Tools.Page):
    ...
    def confDhcp(self, c, f, data):
        ...
        return DHCP.set_dhcp_config(self.sysconf, ndata, iface).addBoth(lambda _: url.root.child('Dhcp'))
