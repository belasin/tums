...
class EditPage(Tools.Page):
    ...
    def form_modInterface(self, data):
        ...
        try:
            ...
            pass
        form.addField('gateway', formal.String(strip=True, validators=[PageHelpers.IPValidator()]), label = "Default Gateway", description = "IP Address that should be used to route all traffic through attached to this interface")
