...
$config->custom->session['blowfish'] = 'attempt to determine your language automatically. Otherwise, available';
...
$ldapservers->SetValue($i,'server','name','bpexample.Friendly');
...
/* Array of base DNs of your LDAP server. Leave this blank to have phpLDAPadmin auto-detect it for you. */
 $ldapservers->SetValue($i,'server','base',array('o=BPEXAMPLE'));
...
// $ldapservers->SetValue($i,'login','dn','cn=Manager,o=BPEXAMPLE');

/* Your LDAP password. If you specified an empty login_dn above, this MUST also be blank. */
// $ldapservers->SetValue($i,'login','pass','wsbpexample');
