...
var initExpandedNodes = '';	// Cokie - initially expanded nodes;
...
function parseSubItems(ulId,parentId)
{
    ...
    for(var no=0;no<menuItems.length;no++){
        ...
        alert(aTag.className);
        if (aTag.className != "domdel.gif"){
