...
# 
# Contains modifications for integration with Enamel. 
...
def usernameFromRequest(request):
    ...
    #if '@' not in username: # I don't want this :/
...
class PersistentSessionWrapper(guard.SessionWrapper):
    ...
    def __init__(
        ...
        **kw):
        ...
        self.cookieKey = '%s-user-cookie' % Settings.LDAPBase.lower()
    ...
    def authenticatedUserForKey(self, key):
        print "Authenticated for key", key
    ...
    # Why wouldn't virtual hosting work? Surely this db should be per application :S - CDA
