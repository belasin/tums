...
class Page(PageHelpers.DefaultPage):
    ...
    def render_content(self, ctx, data):
        ...
        return ctx.tag[
            tags.h3[tags.img(src="/images/netdrive.png"), " Configuration Profiles"],
    ...
    def locateChild(self, ctx, segs):
        ...
        if segs[0] == "copy":
            ...
            return WebUtils.system("cp /usr/local/tcs/tums/profiles/%s /usr/local/tcs/tums/profiles/%s" % (segs[1], dest)).addCallback(ret)
