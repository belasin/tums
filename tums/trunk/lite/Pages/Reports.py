...
class Page(PageHelpers.DefaultPage):
    ...
    sideMenuItems = [
        ...
        (url.root.child("System"), "display", "Information about the hardware this server is running on", 'System and Hardware'),
        (url.root.child("Graphs").child("totals"), "display", "View internal system graphs", 'System Graphs'),
    ...
    def sideMenu(self, avatarId):
        ...
        return tags.div(id="sideCont")[
            [
               [tags.a(_class="MenuOptionLink", href=item[0], title = item[2], onclick="showElement('loading');")[
                    item[3]
                ], tags.br]
    ...
    def render_content(self, ctx, data):
        return ctx.tag[
            tags.h2[tags.img(src="/images/reportsman.png", alt="Reports"), "Reports"],
