...
if os.path.exists('/etc/debian_version'):
    ...
    import gentooDefaults
    defaults = gentooDefaults
    print "System Type: Gentoo"
    sysType = "gentoo"
...
def prePrep():
    ...
    os.system('mkdir /var/lib/samba/profile > /dev/null 2>&1')
    os.system('cp -a /usr/share/doc/shorewall/default-config/* /etc/shorewall/ > /dev/null 2>&1')
    
def prep(*a):
    if os.path.exists('/etc/debian_version'):
        print "Running in Debian compatible mode"
        prePrep()
    else:
        print "Running in Gentoo compatible mode"
...
"""
    if not os.path.exists('/etc/debian_version'):
        print "This doesn't look like Debian..."
        return
    ...
    os.system('cd packages; tar -jxf Twisted-2.5.0.tar.bz2')
    os.system('aptitude install python-zopeinterface build-essential python-dev')
    os.system('cd packages/Twisted-2.5.0; python setup.py install')
...
def help(*a):
    helpText = """TCS Configurator by Colin Alston. Copyright (C) Thusa 2007. 
