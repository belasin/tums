...
startupText = """                        - TCS Setup - 

Welcome to the TCS setup program. This program will require you 
to enter many details pertaining to the configuration of your 
system. These options will be written to the main configuration
file /usr/local/tcs/tums/config.py
...
while (configuring):
    ...
    # Network setups
    netType = radioBox('Internet connection', [('Static', 'Static IP address on WAN port'), ('PPPoE', 'PPPoE connection on WAN port')])
