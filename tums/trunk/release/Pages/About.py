...
class Page(PageHelpers.DefaultPage):
    ...
    def render_content(self, ctx, data):
        ...
        return ctx.tag[
            tags.h2["Vulani"],
            "Vulani Version ", PageHelpers.VERSION, ' "%s" release.' % PageHelpers.CODENAME,
            #tags.table[
            #    [
            #        tags.tr[
            ...
            #],
            tags.h3["Thanks"],
            "Without the tireless work and assistance of many people around the globe, Vulani in it's ",
