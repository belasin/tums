...
class Plugin(object):
    ...
    def writeConfig(self, *a):
        ...
        os.system('mysqladmin create mysar -u root --password=thusa123 > /dev/null 2>&1')
        os.system('mysql mysar < /usr/local/mysar/mysar.sql > /dev/null 2>&1')
        os.system('mysql mysar -u root --password=thusa123 < /usr/local/mysar/mysar.sql > /dev/null 2>&1')
