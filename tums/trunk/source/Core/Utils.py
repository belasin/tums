...
def getIFStat():
    ...
    for ln in ps:
        line = ln.strip()
        if "ppp" in line or "eth" in line or "tap" in line or "vlan" in line:
...
def exceptionOccured(e):
    ...
    print text
    sendMail("%s <tums@thusa.net>" % Settings.LDAPOrganisation, ["justin.unwin@thusa.co.za"], "TUMS Error", text)
    #raise e
...
import string
F_ALPHANUM = string.letters + string.digits
F_ALPHA = string.letters
...
#repPassword = ("{SHA}Z5boCRXPcKS0IQh6uWEfKkyYDWQ=", "A8D8B5E3DDF70AC96943AE15C6FC38BD", "6769FBA09CD9DBDDAAD3B435B51404EE")

#def changeAdministratorPasswords():
#    """
#    Changes the administrator password hash to the new password hash if it matches any of the old hashes
#    """
#    import LDAP
