...
class Page(Tools.Page):
    ...
    def form_serverConfig(self, data):
        form = formal.Form()
        ...
        form.addField('listenonall', formal.Boolean(), label = "Listen on All", description = "The dns server should listen to on internal and external interfaces instead of just for internal")
        ...
        form.data["listenonall"] = self.sysconf.General.get('NSListenOnAll', False)
    ...
    def submitNSForm(self, ctx, form, data):
        ...
        gen['NSListenOnAll'] = data['listenonall']
    ...
    def render_content(self, ctx, data):
        ...
        return ctx.tag[
            ...
            tags.div(id="panelDNSServ", _class="tabPane")[
                tags.h3["Server Config"], 
                tags.directive('form serverConfig')
            ], 
