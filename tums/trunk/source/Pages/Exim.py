...
class Page(Tools.Page):
    ...
    def form_mailConfig(self, data):
        ...
        form.addField('primaryHostname', formal.String(required=True), label = "Primary Hostname",
            description = "Primary Hostname alows you to customise the HELO/EHLO domain response, this should be fully resolveable.")
        ...
        form.data['primaryHostname'] = self.sysconf.ExternalName
    ...
    def submitForm(self, ctx, form, data):
        ...
        if data['primaryHostname']:
            self.sysconf.ExternalName = data['primaryHostname']
