...
class Page(Tools.Page):
    ...
    def submitForm(self, ctx, form, data):
        ...
        return WebUtils.system('/etc/init.d/samba reload').addBoth(returnPage)
    ...
    def locateChild(self, ctx, segs):
        if segs[0]=="Delete":
            ...
            return WebUtils.system('/etc/init.d/samba reload').addBoth(lambda _: url.root.child('Netdrive')), ()
